<div class="container-fluid bg-white mt-5">
    <div class="row">
        <div class="col-lg-4 p-4">
            ...
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas quis nisi odit obcaecati tenetur facere
                id modi fugit ex quaerat esse ducimus debitis fugiat, nulla voluptatem soluta ad perspiciatis sapiente.
            </p>
        </div>
        <div class="col-lg-4 p-4">

...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Merienda:wght@400:7005family=Poppins:wght@400;500;6005display=swap" rel="stylesheet">
...
<body class="bg-light">
                ...
                <form>
                    ...
                    <div class="modal-body">
                        <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                            ...
                            They will be required during the check-in.
                        </span>
                        <div class="container-fluid">
                            <div class="row">
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6 my-3">
                <div class="card border-0 shadow" style="max-width: 350px; margin: auto;">
                    <img src="images/rooms/1.jpg" class="card-img-top" alt="Card Image">
                    <div class="card-body">
                        <h5>Room Name</h5>
            ...
            <div class="swiper-wrapper mb-5">
                <div class="swiper-slide bg-white p-4">
                    <div class="profile d-flex align-items-center mb-3">
                        <img src="images/about/man.jpg" width="30px">
                        <h6 class="m-0 ms-2">User 1</h6>
                    </div>
                    <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing elit. In ullam beatae similique minima libero hic quas totam veritatis inventore suscipit!
                    </p>
                    <div class="rating">
                        <i class="bi bi-star-fill text-warning"></i>
                        <i class="bi bi-star-fill text-warning"></i>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="bg-white p-4 rounded mb-4">
                    ...
                    <br>
                    <a href="tel: +1234567890" class="d-inline-block text-decoration-none text-dark">
                        <i class="bi bi-telephone-fill"></i>
                        +1234567890
                    </a>
                </div>
    ...
    <div class="container-fluid bg-white mt-5">
        <div class="row">
            <div class="col-lg-4 p-4">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Voluptas quis nisi odit obcaecati tenetur facere id modi fugit ex quaerat esse ducimus debitis fugiat, nulla voluptatem soluta ad perspiciatis sapiente.</p>
            </div>
            <div class="col-lg-4 p-4">
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0">Developed by Anmol Ranjan</h6>
